...
# We run a xbutil scan to make sure cards are ready, if you don't see an error message then they are. Type Y if they are ready, if not we will restart the mpd process and try again
